...
print("3. Jouer contre un autre joueur")
...
if choix == '2':
    ...
    def play_vs_human():
        ...
        pygame.display.set_caption('Jeu de Dames - Joueur vs Joueur')
        FONT = pygame.font.SysFont('Arial', 40)
        board = Board()
        current_player = BLACK  # Noir commence toujours
        selected_piece = None
        valid_moves = []
        ...
        while run:
            ...
            current_player_text = "Tour des Noirs" if current_player == BLACK else "Tour des Blancs"
